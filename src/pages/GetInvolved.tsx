            ...
            <div className="lg:col-span-4 space-y-4">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`w-full text-left p-8 rounded-3xl transition-all border-2 ${activeTab === tab.id ? 'border-aeem-gold bg-aeem-gold/15 shadow-lg shadow-aeem-gold/20' : 'border-gray-500 bg-aeem-focus/15 hover:border-gray-200'}`}
                >
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-6 ${activeTab === tab.id ? 'bg-aeem-gold text-white' : 'bg-gray-100 text-gray-500'}`}>
                    <tab.icon size={24} />
                  </div>
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <button
                      ...
                      type="submit"
                      className="w-full bg-aeem-focus/50 text-aeem py-5 rounded-2xl font-black text-lg hover:bg-aeem-gold transition-all shadow-xl flex items-center justify-center gap-3 disabled:opacity-50 hover:scale-[1.02] active:scale-95"
                    >

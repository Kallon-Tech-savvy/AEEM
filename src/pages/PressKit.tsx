          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex items-center justify-between group hover:border-aeem-gold transition-colors">
                  <div className="flex items-center gap-6">
                    <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-aeem-gold">
                      <Briefcase size={24} />
                    </div>
                    <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex flex-col items-center text-center group hover:border-aeem-gold transition-colors">
                  ...
                  <button className="mt-auto px-6 py-2 bg-aeem-charcoal text-white rounded-full text-xs font-bold hover:bg-aeem-gold transition-colors">
                    Download
                  </button>
                </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-aeem-gold rounded-3xl p-12 text-center text-white">
            ...
            <a href="mailto:press@aeem.org" className="text-2xl font-black border-b-2 border-white hover:text-aeem-charcoal hover:border-aeem-charcoal transition-colors pb-2">
              press@aeem.org
            </a>
          </div>
        </div>

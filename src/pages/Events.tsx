...
const FALLBACK_EVENTS: Event[] = [
  {
    ...
    status: "upcoming",
    cover_image_url: "../../public/assets/gallery/Image.jpg",
  ...
  },
  {
    ...
    status: "completed",
    cover_image_url: "../../public/assets/gallery/Activity.jpg",
...
const Events: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="pt-40 pb-24 bg-aeem-focus/15 text-aeem">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-xl text-aeem max-w-2xl">
                  ...
                  <div key={event.slug} className="group flex flex-col md:flex-row bg-aeem-focus/25 rounded-3xl overflow-hidden border border-aeem-border shadow-sm hover:shadow-xl transition-all">
                    ...
                    <div className="p-8 md:w-3/5 flex flex-col">
                       <div className="flex flex-wrap gap-4 text-[10px] font-black uppercase tracking-widest text-aeem-gold mb-4">
                          ...
                          <span className="flex items-center gap-1 text-aeem"><Clock size={12} /> 09:00 AM</span>
                       </div>
                       <h3 className="text-2xl font-black mb-4 group-hover:text-aeem-gold transition-colors">{event.title}</h3>
                       <p className="text-sm text-aeem mb-8 leading-relaxed line-clamp-3">{event.description}</p>
                       <div className="mt-auto flex items-center justify-between">
                          <div className="flex items-center gap-1.5 text-xs font-bold text-aeem">

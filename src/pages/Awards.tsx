      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-soft border border-gray-100">
               ...
               <form onSubmit={handleVerify} className="relative mb-8">
                  <input
                    ...
                    className="w-full pl-6 pr-16 py-5 rounded-2xl border border-gray-200 focus:outline-none focus:border-aeem-gold transition-all font-bold tracking-wider uppercase"
                  />
                  <button
                    disabled={loading}
                    type="submit"
                    className="absolute right-3 top-1/2 -translate-y-1/2 w-12 h-12 bg-aeem-charcoal text-white rounded-xl flex items-center justify-center hover:bg-aeem-gold transition-colors disabled:opacity-50"
                  >
               ...
               {error && (
                 <motion.div
                   ...
                   className="flex items-center gap-3 p-4 bg-red-50 text-red-600 rounded-xl border border-red-100 mb-8"
                 >
                   <XCircle size={20} />
                 ...
                 >
                    ...
                    <div className="p-8">
                       <div className="flex items-start gap-6 mb-8">
                          <div className="w-24 h-24 rounded-2xl bg-white p-1 shadow-sm border border-gray-100 flex-shrink-0 overflow-hidden">
                             <img
                          ...
                          <div>
                             <h3 className="text-2xl font-black text-aeem-charcoal mb-1">{result.recipient_name}</h3>
                       ...
                       <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                          <div className="flex items-center gap-3">
                             <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-aeem-gold shadow-sm border border-gray-50">
                                <Calendar size={18} />
                             </div>
                             <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase">Issue Date</p>
                                <p className="text-sm font-black text-aeem-charcoal">{new Date(result.issue_date).toLocaleDateString()}</p>
                             </div>
                          </div>
                          <div className="flex items-center gap-3">
                             <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-aeem-gold shadow-sm border border-gray-50">
                             ...
                             <div>
                                ...
                                <p className="text-sm font-black text-aeem-charcoal">{result.metadata.category || "Excellence"}</p>
                             </div>
                          </div>
                          <div className="flex items-center gap-3 sm:col-span-2">
                             ...
                             <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase">Identity Reference</p>
                                <p className="text-sm font-black text-aeem-charcoal">{result.metadata.identity_ref || "N/A"}</p>
                             </div>
                          </div>
                       </div>

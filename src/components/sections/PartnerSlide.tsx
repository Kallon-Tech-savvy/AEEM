...
export function PartnerTicker() {
  ...
  return (
    <div className="w-full py-10 bg-aeem-bg dark:bg-aeem-charcoal overflow-hidden border-y border-gray-100 dark:border-white/5 relative">
        ...
        >
          {dualPartners.map((partner, index) => (
            <div
              ...
              className="flex items-center justify-center shrink-0 h-12 transition-all duration-300"
            >
